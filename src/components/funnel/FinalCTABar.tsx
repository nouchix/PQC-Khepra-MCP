      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          <p className="text-gray-400 text-lg max-w-xl mx-auto">
            Launch your Agentic SOC free. Every tool call attested, signed, and auditable.
            Upgrade to earn your{" "}
            <span className="text-[#d4af37] font-semibold">ADINKHEPRA certification badge</span>{" "}
            — the proof your CISO needs.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            >
              {user ? "Open SOC Dashboard" : "Launch SOC — Free"}
            </Button>
            <Button
              size="lg"
              variant="outline"
          ...
          <p className="text-xs text-gray-500 pt-4">
            Free SOC tier requires no credit card. ML-DSA-65 signed audit trail from day one.
          </p>
        </motion.div>
      </div>
    </section>
