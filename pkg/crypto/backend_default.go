//go:build !community && !premium && !hsm
// +build !community,!premium,!hsm
...
// Default backend when no build tags are specified
// Falls back to community edition (Cloudflare CIRCL)
...
// initBackendImpl initializes the default backend (community edition)
