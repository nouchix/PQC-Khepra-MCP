...
var SecretPatterns = []SecretPattern{
	...
	{Name: "slack-webhook", Pattern: `(?i)(?:^|[\s"'])https://hooks\.slack\.com/services/T[A-Z0-9]+/B[A-Z0-9]+/[A-Za-z0-9]+(?:[\s"']|$)`, Severity: SeverityHigh},
	{Name: "discord-token", Pattern: `(?i)[MNO][A-Za-z0-9\-_]{23}\.[A-Za-z0-9\-_]{6}\.[A-Za-z0-9\-_]{27}`, Severity: SeverityCritical},
	{Name: "discord-webhook", Pattern: `(?i)(?:^|[\s"'])https://(?:canary\.)?discord(?:app)?\.com/api/webhooks/[0-9]{17,20}/[A-Za-z0-9\-_]{60,68}(?:[\s"']|$)`, Severity: SeverityHigh},
